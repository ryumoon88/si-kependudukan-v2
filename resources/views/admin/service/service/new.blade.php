            ...
            <div class="col-12 col-md-6">
                <div class="card">
                    ...
                    @if (session('error'))
                        @dd(session('error'))
                    @endif
                    <form class="card-body" method="POST" action="{{ route('admin.service.service.store') }}">
                        @csrf
                        @method('POST')
                        ...
                        <div class="d-flex flex-column">
                            <div class="mb-3 data-field d-flex flex-column">
                                ...
                                <select
                                    class="form-select form-select-sm @error('service_category_id')
                                    is-invalid
                                @enderror"
                                    name="service_category_id" aria-label="Default select example">
