                        ...
                        <div class="tab-content pt-2">
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ Auth::user()->id_card_number }}</div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ Auth::user()->resident->phone_number }}</div>
                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input disabled type="text" class="form-control"
                                                value="{{ Auth::user()->id_card_number }}">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Full Name</label>
                                        <div class="col-md-8 col-lg-9">
                                            <input disabled type="text" class="form-control disabled" id="name"
                                                placeholder="name"
                                                value="{{ old('last_name', Auth::user()->resident->birth->name) }}">
                                        </div>
                                    </div>
