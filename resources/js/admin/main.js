...
(function () {
    ...
    function setModal(title, body, type) {
        ...
        if (type == 'yesno') {
            ...
            modalCancelAction.addClass('btn-danger btn-sm')
            modalSubmitAction.removeClass('btn-primary')
            modalSubmitAction.addClass('btn-success btn-sm')
    ...
    function setModalAction(callback) {
        modalSubmitAction.click(callback);
    }
    ...
    window.setModalAction = setModalAction

    function showAlert(type, message) {
        var alert = `
            <div id="alert" class="alert alert-${type} alert-dismissible fade show" role="alert">
                <i class="bi ${type == 'success' ? 'bi-check-circle' : 'bi-x-circle'} me-1" id="alert-icon"></i>
                ${message}
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        `
        $('main').prepend(alert);
        var al = new bootstrap.Alert('#alert');
        al.dispose();
    }
